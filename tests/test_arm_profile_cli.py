...
def test_threshold_defaults_to_the_joints_hardware_tuned_value() -> None:
    ...
    # 150, not the 400 it shipped with: wrist_roll's walls press at only 272/288, so 400
    # was above anything the joint could produce and contact could never fire (#43).
    assert arm_cmd._profile_threshold(args, "wrist_roll") == 150
