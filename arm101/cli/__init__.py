...
from arm101.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/arm101-cli/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    from arm101.cli._commands import set_baudrate as _set_baudrate_cmd
    ...
    parser = _CliArgumentParser(
        prog="arm101-cli",
        description="arm101-cli — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
    ...
    _set_baudrate_cmd.register(sub)
