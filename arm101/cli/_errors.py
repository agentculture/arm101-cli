...
Every failure inside arm101-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`arm101.cli._output`,
...
# Exit-code policy. Documented in ``arm101-cli learn`` output.
# 0      = success
